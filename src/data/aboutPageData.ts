...
export const hobbiesAndInterests = [
  {
    title: "ランニング",
    description:
      "ランニングが日課です(しんどい時は歩きます)。早朝や夕方に走ることで、心身ともにリフレッシュでき、一日の良いスタートや締めくくりになっています。季節の移り変わりを感じながら走るのが特に好きで、その時々の景色を楽しんでいます。",
  },
  {
    title: "書店巡り",
    description:
      "休日には書店を巡るのが楽しみです。技術書コーナーをのぞいてみたり、普段あまり関わりのない分野の本棚を見て回ったりするのが好きです。大型の書店だと全ての棚を徘徊してしまい、つい長居してしまうことも。新しい本の匂いや、本に囲まれた静かな空間が心地よく感じます。",
  },
];
